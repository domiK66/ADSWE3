import { IonContent, IonIcon, IonItem, IonLabel, IonTitle, IonHeader, IonToolbar, IonList, IonListHeader, IonMenu, IonMenuToggle, IonNote } from '@ionic/react';

import { useLocation } from 'react-router-dom';
import { homeOutline, homeSharp, listOutline, listSharp, logInSharp, logInOutline, logOutSharp, logOutOutline, addSharp, addOutline, alarmOutline, alarmSharp, alertOutline, alertSharp } from 'ionicons/icons';
import './Menu.css';
        ...
        <IonList>
          ...
          {securityItem2 !== null && (
            <IonMenuToggle key={'sec3'} auto-hide="false">
              <IonItem routerLink={securityItem2.url} lines="none" onClick={securityItem2.onClick}>
                <IonIcon slot="start" ios={securityItem2.iosIcon} md={securityItem2.mdIcon} />
